...
/*! \struct cell
    \brief structure de cellule pour les listes cha�nees de successeurs.
*/
typedef struct cell {
//! index du sommet
  int som;
//! poids de l'arc pour les graphes pond�r�s 
  TYP_VARC v_arc; 
...
//!  tableau des extremit�s initiales d'arcs 
  int *tete;        
//!  tableau des extremit�s finales d'arcs 
  int *queue;       

  /* informations additionelles ajoutees aux arcs */

//!  tableau des valeurs associ�es aux arcs
  TYP_VARC *v_arcs;

  /* informations additionelles ajoutees aux sommets */

//!  tableau des valeurs associ�es aux sommets
  TYP_VSOM *v_sommets;
